...
class User:  
    ...
    def new_user(self):
        ...
        location = Location.find_location(self)
        print("Enter the City Name - ",location)
        address = location
    ...
    def user_dashboard(self,name):
        ...
        Banner.print_banner(self,"                        Welcome Back ")
        print(name)
        print()
        print("----------------------------------********---------------------------------".center(40))
        print()
...
class Restro :
    ...
    def new_registration(self):
        ...
        Notification.registration_confirmation(self,ph_number,restro_name,date)
        Menu.add_menu(self)
...
class Others:  
    def main_home(self):  
        Banner.print_banner(self,"-------------------------------------------------------------------------------".center(40))
        print()
        Banner.print_banner(self,"                          Welcome to Harry's Kitchen")
        print()
        Banner.print_banner(self,"-------------------------------------------------------------------------------".center(40))  
        print("")
        print("Please choose the options from below")
